...
Lazyscraper could always use more documentation, whether as part of the
official lazyscraper docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
3. Check https://travis-ci.org/ivbeg/lazyscraper/pull_requests
